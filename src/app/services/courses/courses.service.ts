...
export class CoursesService {
  ...
  getCourses$(searchByPipeParams: SearchByPipeParams = null): Observable<Course[]> {
    this.loadingService.startLoading();

    return of(searchByPipeParams ? this.searchByPipe.transform(COURSES, searchByPipeParams) : COURSES).pipe(
      delay(2000),
